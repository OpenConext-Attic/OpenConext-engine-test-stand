...
namespace OpenConext\Component\EngineBlock\Tests;

use OpenConext\Component\EngineBlock\PrintRParser;

class PrintRParserTest extends \PHPUnit_Framework_TestCase
{
    public function testParser()
    {
        $content = file_get_contents(__DIR__ . '/../Resources/fixture/joost.printr');
